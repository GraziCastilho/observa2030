...
export const ODS_17: Ods[] = [
  ...
  { n:2, cor:"#DDA63A", img:`${BASE}/ODS2.svg`, nome:"Fome Zero e Agricultura Sustentável",
    ...
    metas:[
      ...
      "4.b — Até 2020, substancialmente ampliar globalmente o número de bolsas de estudo para os países em desenvolvimento, em particular os países menos desenvolvidos, pequenos Estados insulares em desenvolvimento e os países africanos, para o ensino superior, incluindo programas de formação profissional, de tecnologia da informação e da comunicação, técnicos, de engenharia e programas científicos",
    ...
    metas:[
      ...
      "14.6 — Até 2020, proibir certas formas de subsídios à pesca, que contribuem para a sobrecapacidade e a sobrepesca, e eliminar os subsídios que contribuam para a pesca ilegal, não reportada e não regulamentada, e abster-se de introduzir novos subsídios como estes",
      ...
      "14.c — Assegurar a conservação e o uso sustentável dos oceanos e seus recursos pela implementação do direito internacional, como refletido na UNCLOS, que provê o arcabouço legal para a conservação e utilização sustentável dos oceanos e dos seus recursos"
    ] },
    ...
    metas:[
      ...
      "17.2 — Países desenvolvidos implementarem plenamente os seus compromissos em matéria de assistência oficial ao desenvolvimento [AOD], inclusive fornecer 0,7% da renda nacional bruta [RNB] em AOD aos países em desenvolvimento",
      "17.3 — Mobilizar recursos financeiros adicionais para os países em desenvolvimento a partir de múltiplas fontes",
      "17.4 — Ajudar os países em desenvolvimento a alcançar a sustentabilidade da dívida de longo prazo por meio de políticas coordenadas destinadas a promover o financiamento, a redução e a reestruturação da dívida",
      "17.5 — Adotar e implementar regimes de promoção de investimentos para os países menos desenvolvidos",
      "17.6 — Melhorar a cooperação Norte-Sul, Sul-Sul e triangular regional e internacional e o acesso à ciência, tecnologia e inovação, e aumentar o compartilhamento de conhecimentos em termos mutuamente acordados",
      "17.7 — Promover o desenvolvimento, a transferência, a disseminação e a difusão de tecnologias ambientalmente corretas para os países em desenvolvimento, em condições favoráveis",
      "17.8 — Operacionalizar plenamente o Banco de Tecnologia e o mecanismo de capacitação em ciência, tecnologia e inovação para os países menos desenvolvidos até 2017, e aumentar o uso de tecnologias de capacitação",
      "17.9 — Reforçar o apoio internacional para a implementação eficaz e orientada da capacitação em países em desenvolvimento, a fim de apoiar os planos nacionais para implementar todos os objetivos de desenvolvimento sustentável",
      "17.10 — Promover um sistema multilateral de comércio universal, baseado em regras, aberto, não discriminatório e equitativo no âmbito da Organização Mundial do Comércio",
      ...
      "17.12 — Concretizar a implementação oportuna de acesso a mercados livres de cotas e taxas, de forma duradoura, para todos os países menos desenvolvidos, de acordo com as decisões da OMC",
      ...
      "17.16 — Reforçar a parceria global para o desenvolvimento sustentável, complementada por parcerias multissetoriais que mobilizem e compartilhem conhecimento, expertise, tecnologia e recursos financeiros",
...
export const ODS_EXTRA: Ods[] = [
  {
    ...
    metas: [
      ...
      "18.3 — Garantir Tratamento Justo: Garantir aos povos indígenas e afrodescendentes tratamento digno, justo e equânime perante os órgãos do sistema de justiça, de segurança pública e administrativos do Estado, assegurando a efetivação e a ampliação do acesso à justiça e o devido processo legal.",
      "18.4 — Representatividade: Garantir a representatividade equitativa dos povos indígenas e afrodescendentes nas instâncias, colegiados e órgãos de Estado e no quadro de pessoal de empresas públicas e privadas, levando em conta a interseccionalidade.",
      "18.5 — Promover a Reparação: Promover a reparação integral das violações socioeconômica e cultural, das perdas territoriais e dos impactos ambientais nos territórios dos povos indígenas e afrodescendentes, especialmente os integrantes de comunidades tradicionais, favelas e comunidades urbanas, garantindo o direito à memória, verdade e justiça.",
      ...
      "18.6 — Assegurar Moradias Adequadas: Assegurar moradias adequadas, seguras e sustentáveis aos povos indígenas e afrodescendentes, incluindo comunidades tradicionais, favelas e comunidades urbanas, com garantia de equipamentos e serviços públicos de qualidade, com especial atenção à população em situação de rua.",
      "18.7 — Assegurar à Saúde: Assegurar o acesso à atenção à saúde de qualidade, não discriminatória, para os povos indígenas e afrodescendentes, bem como o respeito às suas culturas e saberes ancestrais, garantido o fortalecimento da saúde pública.",
      "18.8 — Assegurar Educação de Qualidade: Assegurar a educação de qualidade e não discriminatória aos afrodescendentes, quilombolas e povos indígenas, bem como o respeito às suas culturas e histórias, garantido o fortalecimento da educação pública.",
    ],
  },
  {
    ...
    metas: [
      ...
      "Valorização do impacto da manifestação artística na consolidação de uma perspectiva sustentável, bem como ser um ator de transformação social na área, tanto de forma prática quanto acadêmica.",
      ...
      "Promoção de princípios do Jornalismo para Paz (Peace Journalism) ou Jornalismo Cidadão para promover formas alternativas de abordagem noticiosa que possam possibilitar a contextualização de diversos acontecimentos.",
      "Educação de qualidade, inclusiva e libertadora, que forme indivíduos para pensarem de forma crítica, inclusive a partir da mídia-educação ou media literacy.",
      "Consolidação da comunicação para paz, promovendo uma visão desconstruída sobre conflitos, vendo-os do ponto de vista do diálogo e do crescimento mútuo, além da desconstrução da violência naturalizada pela própria linguagem.",
  ...
  },
  {
    ...
    metas: [
      ...
      "Garantir o cumprimento da Lei nº 10.639, que torna obrigatório o ensino da história e cultura afro-brasileira e africana em todas as escolas, tanto de rede pública quanto privada, do ensino fundamental ao médio.",
      "Promover a participação de representantes dos povos originários e comunidades tradicionais nos conselhos e comissões de políticas públicas, sempre privilegiando-se estruturas anteriores de formação para que haja maior representatividade com qualidade nos debates.",
      "Defender as demarcações de terra dos povos originários e comunidades tradicionais para além da temporalidade e do corte constitucional, impedindo o Estado a ser um real mediador e defensor dos justos estudos antropológicos e mais rápidos fluxos jurídico-demarcatórios.",
      "Garantir o direito à consulta prévia dos povos originários e comunidades tradicionais quanto a qualquer ação que possa ser planejada ou passada pelos territórios tomados como tradicionais.",
      "Fortalecer a rede de articulação dos povos e comunidades tradicionais e o banco de dados das organizações, incentivando organizações sociais, o poder público em todos seus níveis e as universidades na promoção do diálogo antropologicamente adequado com estes povos e comunidades.",
      "Divulgar as legislações que dizem respeito aos povos tradicionais, inclusive por meio de linguagem mais direta e acessível, considerando as matrizes culturais e linguísticas de cada comunidade.",
      ...
      "Investir em pesquisas e ações para o diagnóstico socioeconômico e cultural dos povos tradicionais, incentivar as universidades ao protagonismo da ação científica em bases éticas e antropologicamente sensíveis.",
      "Fortalecer políticas de desenvolvimento ambiental, reconhecendo o impacto que as atividades econômicas de mineração e do agronegócio têm sobre os territórios tradicionais, exercendo maior controle sobre seus impactos diretos e reflexos sobre os diversos ecossistemas.",
      "Defender o direito à manifestação religiosa, combatendo a intolerância pautada sobre a violência cultural latente e o etnocentrismo.",
      "Valorizar as ciências e saberes originários, como epistemologias e ontologias igualmente importantes, verdadeiras e eficazes, garantindo o retorno aos povos originários de toda utilização de seus conhecimentos.",
      "Estabelecer políticas de saúde específicas para os contextos dos povos tradicionais, com proteção prioritária, controle social pleno e processos de comunicação adequados sobre doenças e políticas públicas de saúde.",
    ],
  },
];
...
export function PainelDetalhe({
  ...
  const isMetas = !ods.tipo || ods.tipo === "metas";
  const vw = typeof window !== "undefined" ? window.innerWidth : 1024;
  const style: import("react").CSSProperties = {
    position: "fixed",
    zIndex: 1000,
    left: position ? Math.min(Math.max(position.x, 190), Math.max(vw - 190, 190)) : "50%",
    top: position ? Math.max(position.y - 20, 60) : "50%",
    ...
    borderRadius: 20,
    padding: "20px 22px",
    border: `3px solid ${ods.cor}`,
    boxShadow: "0 12px 48px rgba(0,0,0,0.35), 0 0 0 4000px rgba(0,0,0,0.25)",
    animation: "fadeUp 0.2s ease",
  };
  return (
    <div role="dialog" aria-modal="true" className="bg-card text-foreground" style={style}>
      ...
      <div className="flex items-start gap-4">
        ...
        >
          <img src={ods.img} alt={`ODS ${ods.n}`} loading="lazy" className="h-full w-full object-contain" />
        </div>
        <div className="min-w-0 flex-1">
          <span className="text-xs font-semibold uppercase tracking-wide" style={{ color: ods.cor }}>
            ODS {ods.n}
            {ods.n >= 18 ? " — Adjacente" : ""}
          </span>
          <h3 className="text-xl font-bold leading-tight text-foreground">{ods.nome}</h3>
        </div>
        <button
          onClick={onClose}
          aria-label="Fechar"
          className="rounded-full border px-2.5 py-1 text-sm text-muted-foreground transition-colors hover:bg-muted"
        >
          ✕
        </button>
      </div>
      ...
      <div className="mt-5">
        <h4 className="text-sm font-bold uppercase tracking-wide text-muted-foreground">Objetivo</h4>
        <p className="mt-1 leading-relaxed text-foreground">{ods.objetivo}</p>
      </div>

      <h4 className="mt-6 text-sm font-bold uppercase tracking-wide text-muted-foreground">
        {isMetas ? "Metas Principais" : "Visão de Futuro"}
      </h4>
        ...
        {ods.metas.map((m, i) => (
          <li key={i} className="flex gap-3 rounded-xl bg-muted/60 p-3">
            {isMetas ? (
              ...
              <span className="mt-2 h-2 w-2 shrink-0 rounded-full" style={{ background: ods.cor }} />
            )}
      ...
      {ods.n >= 18 && (
        <p className="mt-5 border-t pt-4 text-xs leading-relaxed text-muted-foreground">
          Fonte: CABRAL, R.; GEHRE, T. (Org.). Guia Agenda 2030: integrando ODS, educação e sociedade. São
          Paulo, 2020. Disponível em: guiaagenda2030.org
        </p>
      )}
    </div>
  );
...
export default function RodaODS({ compact = false }: { compact?: boolean }) {
  ...
  const [dim, setDim] = useState(compact ? 420 : 560);

  useEffect(() => {
    const max = compact ? 500 : 800;
    const calc = () => setDim(Math.min(window.innerWidth - 40, max));
    calc();
  ...
  const C = dim / 2;
  const sc = dim / 560;
  const TL = Math.round(70 * sc);
  const R  = Math.round(216 * sc);
  const CR = Math.round(370 * sc);
  ...
  return (
    <div className="flex w-full flex-col items-center">
      ...
      <div className="relative" style={{ width: dim, height: dim }}>
        ...
        {ODS_17.map((o, i) => {
          const rad = ((i * 360) / 17 - 90) * (Math.PI / 180);
          const deg = (i * 360) / 17 - 90;
          const x = C + R * Math.cos(rad) - TL / 2;
          const y = C + R * Math.sin(rad) - TL / 2;
          const hovered = hoveredN === o.n;

          return (
<div
  key={o.n}
  onMouseEnter={() => setHoveredN(o.n)}
  onMouseLeave={() => setHoveredN(null)}
  style={{ position: "absolute", left: Math.round(x), top: Math.round(y) }}
>              {/* Tooltip */}
              {hovered && (
                <div style={{
                  position: "absolute",
             ...
             <button
              onClick={() => handleClick(o.n)}
                ...
                aria-label={`ODS ${o.n} — ${o.nome}`}
                className="transition-transform duration-150"
                style={{
                  width: TL,
                  height: TL,
                  borderRadius: Math.round(9 * sc),
                  overflow: "hidden",
                  background: o.cor,
                  border: "none",
                  padding: 0,
                  transform: hovered ? `rotate(${deg}deg) scale(1.1)` : `rotate(${deg}deg)`,
                  transformOrigin: "center center",
                  boxShadow: hovered
                    ? `0 8px 28px ${o.cor}cc, 0 0 0 3px #fff, 0 0 0 5.5px ${o.cor}`
        ...
        <div
          ...
          style={{
            ...
            padding: Math.round(6 * sc),
            zIndex: 10,
          }}
        >
          <img src={LOGO_OBSERVA} alt="Observa 2030" loading="lazy" className="h-full w-full object-contain" />
        </div>
      </div>
          ...
          {ODS_EXTRA.map((o) => (
            ...
            >
              <span
                ...
                style={{ background: o.cor, boxShadow: "0 2px 10px rgba(0,0,0,0.22)" }}
              >
