      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-14 md:grid-cols-[auto_1fr_auto] md:items-center">
        ...
        <div>
          ...
          <p className="mt-2 max-w-xl text-sm leading-relaxed text-primary-foreground/80">
            Juntos por uma Pós-graduação comprometida com a Agenda 2030 e os Objetivos de Desenvolvimento Sustentável.
          </p>
        </div>
        <ul className="space-y-3 text-sm">
          <li>
            <a href="https://www.instagram.com/observa2030uergs" target="_blank" rel="noreferrer"
              ...
              <img src={ICON_INSTAGRAM} alt="Instagram" className="h-5 w-5 shrink-0" />
              @observa2030uergs
            </a>
          </li>
          <li>
            <a href="https://www.facebook.com/profile.php?id=61578130242476" target="_blank" rel="noreferrer"
              className="flex items-center gap-2 text-primary-foreground/90 transition-opacity hover:opacity-70">
              <img src={ICON_FACEBOOK} alt="Facebook" className="h-5 w-5 shrink-0" />
              Observa Uergs
            </a>
          </li>
          <li>
            <a href="mailto:observa2030uergs@gmail.com"
              className="flex items-center gap-2 text-primary-foreground/90 transition-opacity hover:opacity-70">
              <img src={ICON_GMAIL} alt="Gmail" className="h-5 w-5 shrink-0" />
